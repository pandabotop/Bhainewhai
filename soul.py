...
bot_token = '8422750253:AAFH8gYkUosP-rRIIXo_Pmaz4eixeZPjmUM'  # Replace with your bot token
...
ADMIN_ID =   # Replace with the actual admin's user ID
...
def handle_contact_admin(message):
    bot.reply_to(message, f"📞 @WHITE_X_PANDAl: {ADMIN_ID}")
